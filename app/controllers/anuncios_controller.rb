class AnunciosController < ApplicationController
  ...
  def create
    ...
    EmailsMailer.anuncios(@anuncio).deliver_now
  end
  ...
  private
    ...
    def anuncio_params
      params.require(:anuncio).permit(:nome, :email, :telefone, :cidade, :bairro, :categoria, :tipo, :dormitorios, :banheiros, :garagem, :area, :valor, :descricao)
    end
end
